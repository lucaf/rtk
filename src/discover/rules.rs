...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^swift\s+(build|test|package|run)\b",
        rtk_cmd: "rtk swift",
        rewrite_prefixes: &["swift"],
        category: "Build",
        savings_pct: 75.0,
        subcmd_savings: &[("test", 80.0), ("build", 70.0)],
        subcmd_status: &[],
    },
    RtkRule {
        pattern: r"^xcodebuild\s",
    ...
    RtkRule {
        pattern: r"^(?:xcrun\s+)?xctrace\s+(list|record|export)",
        rtk_cmd: "rtk xctrace",
        rewrite_prefixes: &["xcrun xctrace", "xctrace"],
        category: "Infra",
        savings_pct: 75.0,
        subcmd_savings: &[("list", 80.0)],
        subcmd_status: &[],
    },
    RtkRule {
